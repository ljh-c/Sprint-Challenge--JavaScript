...
console.log(tyranno.weight_kg);

// What was the diet of a velociraptor?
console.log(raptor.diet);

// How long was a stegosaurus?
console.log(stego.length_m);
...
const unsortedUnis = graduates.map(alum => alum.university);
...
const contactInfo = graduates.map(alum => `${alum.first_name} ${alum.email}`);
...
// array of graduate objects that have a university with "Uni" in the name
let filteredUnis = graduates.filter(alum => alum.university.includes('Uni'));

// array of objects that only have university property
...
*/
const populationArr = zooAnimals.map(animal => animal.population);
const populationTotal = populationArr.reduce(((sum, current) => sum + current), 0);
